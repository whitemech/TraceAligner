...
public class GeneralEncodingConjunctiveGoal extends AbstractEncoding {
    ...
    public Domain generateDomain() {
        ...
        TypedSymbol act = new TypedSymbol(new Symbol(Symbol.Kind.TYPE, "act"));
        ...
        NamedTypedList automaton = new NamedTypedList(new Symbol(Symbol.Kind.PREDICATE, "automaton"));
        automaton.add(s1);
        automaton.add(e);
        automaton.add(s2);
        ...
        pre_cur_state.setAtom(Arrays.asList(new Symbol(Symbol.Kind.PREDICATE, "cur_state"), new Symbol(Symbol.Kind.VARIABLE, "?t1")));
        sync_pre.addChild(pre_cur_state);

        Exp pre_trace = new Exp(Connective.ATOM);
        pre_trace.setAtom(Arrays.asList(new Symbol(Symbol.Kind.PREDICATE, "trace"), new Symbol(Symbol.Kind.VARIABLE, "?t1"),
        ...
        eff_cur_state_t1.setAtom(Arrays.asList(new Symbol(Symbol.Kind.PREDICATE, "cur_state"), new Symbol(Symbol.Kind.VARIABLE, "?t1")));
        ...
        eff_cur_state_t2.setAtom(Arrays.asList(new Symbol(Symbol.Kind.PREDICATE, "cur_state"), new Symbol(Symbol.Kind.VARIABLE, "?t2")));
        sync_eff.addChild(eff_cur_state_t2);

        Exp eff_forall = new Exp(Connective.FORALL);
        eff_forall.setVariables(Arrays.asList(s1, s2));
        ...
        cond_expr_1.setAtom(Arrays.asList(new Symbol(Symbol.Kind.PREDICATE, "cur_state"),
                new Symbol(Symbol.Kind.VARIABLE, "?s1")));
        eff_when_cond.addChild(cond_expr_1);
        Exp cond_expr_2 = new Exp(Connective.ATOM);
        cond_expr_2.setAtom(Arrays.asList(new Symbol(Symbol.Kind.PREDICATE, "automaton"),
                new Symbol(Symbol.Kind.VARIABLE, "?s1"), new Symbol(Symbol.Kind.VARIABLE, "?e"),
                new Symbol(Symbol.Kind.VARIABLE, "?s2")));
        ...
        add_forall.setVariables(Arrays.asList(s1, s2));
        ...
        goto_eff.setVariables(Arrays.asList(s1, s2));
        ...
        dummy_trans_cond.setAtom(Arrays.asList(new Symbol(Symbol.Kind.PREDICATE, "dummy_trans"),
                new Symbol(Symbol.Kind.VARIABLE, "?s1"), new Symbol(Symbol.Kind.VARIABLE, "?de"),
                new Symbol(Symbol.Kind.VARIABLE, "?s2")));
    ...
    private void _addConstraintStateObjs(Problem p) {
        for (Automaton<?> a : this.constraint_automata) {
            ...
            if (a.getAcceptStates().size() > 1) {
                TypedSymbol gs = new TypedSymbol(new Symbol(Symbol.Kind.CONSTANT, "gs_" + a.getId()));
    ...
    private void _addActivities(Problem p) {
        for (String event : this.trace_automaton.getAlphabet()) {
            ...
            act.addType(new Symbol(Symbol.Kind.TYPE, "act"));
            p.addObject(act);
        }
    ...
    private void _addInit(Problem p) {
        ...
        cur_state.setAtom(Arrays.asList(new Symbol(Symbol.Kind.PREDICATE, "cur_state"),
        ...
        for (Transition<String> trans : this.trace_automaton.getTransitionFunction()) {
            ...
            trans_trace.setAtom(Arrays.asList(new Symbol(Symbol.Kind.PREDICATE, "trace"),
        ...
        for (Automaton<String> a : this.constraint_automata) {
            ...
            a_cur_state.setAtom(Arrays.asList(new Symbol(Symbol.Kind.PREDICATE, "cur_state"),
                    new Symbol(Symbol.Kind.CONSTANT, String.format("s_%s_%s", a.getId(), a.getInitState().getName()))));
            ...
            for (Transition<String> trans : a.getTransitionFunction()) {
                ...
                trans_automaton.setAtom(Arrays.asList(new Symbol(Symbol.Kind.PREDICATE, "automaton"),
                        new Symbol(Symbol.Kind.CONSTANT, String.format("s_%s_%s", a.getId(), trans.getInputState().getName())),
                        new Symbol(Symbol.Kind.CONSTANT, trans.getSymbol()),
                        new Symbol(Symbol.Kind.CONSTANT, String.format("s_%s_%s", a.getId(), trans.getOutputState().getName()))));
            ...
            if (automaton_accept.size() > 1) {
                for (State s : automaton_accept) {
                    Exp trans_automaton = new Exp(Connective.ATOM);
                    trans_automaton.setAtom(Arrays.asList(new Symbol(Symbol.Kind.PREDICATE, "dummy_trans"),
                            new Symbol(Symbol.Kind.CONSTANT, String.format("s_%s_%s", a.getId(), s.getName())),
                            new Symbol(Symbol.Kind.CONSTANT, "dummy"),
                            new Symbol(Symbol.Kind.CONSTANT, "gs_" + a.getId())));
                    p.addInitialFact(trans_automaton);
                }
            }
        }
    ...
    private void _addGoal(Problem p) {
        Exp conj_goal = new Exp(Connective.AND);
        ...
        conj_goal.addChild(fin_state_goal);
        for (Automaton<?> a : this.constraint_automata) {
            ...
            if (a.getAcceptStates().size() > 1) {
                ...
                cur_state_goal.setAtom(Arrays.asList(new Symbol(Symbol.Kind.PREDICATE, "cur_state"),
                        new Symbol(Symbol.Kind.CONSTANT, String.format("s_%s_%s", a.getId(), a.getAcceptStates().get(0).getName()))));
            }
            conj_goal.addChild(cur_state_goal);
        }
        p.setGoal(conj_goal);
...
//
//            GeneralEncodingConjunctiveGoal ae = new GeneralEncodingConjunctiveGoal("gen0", t, c, false);
//            List<Object> res = ae.generate(trace_no);
